...
Phase 008's payment orchestration/Iranian gateway integration module, and
Phase 009's order/invoice/fulfillment module are done — see `CLAUDE.md`'s
"Current status" for exactly what each does and doesn't include. Next up:
the remaining Phase 1 domain modules.
